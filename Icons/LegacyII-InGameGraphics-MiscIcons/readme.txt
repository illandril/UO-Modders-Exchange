MiscIcons Icon Pack -- Legacy II Skin Styling using In Game Graphics
 Code and Packaging by Illandril (illandril@modders-exchange.net)
 Icons by Zym Dragon

Details:
  This icon pack adds Number icons from 0-9 to use when selecting an icon for Macros.
...
Installation:
  ...
  The directory structure should look like the following:
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/LegacyII-InGameGraphics-MiscIcons/
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/LegacyII-InGameGraphics-MiscIcons/Icons/
