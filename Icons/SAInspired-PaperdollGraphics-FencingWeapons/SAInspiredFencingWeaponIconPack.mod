...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<UiMod name="SAInspiredFencingWeaponIconPack" version="1.0" date="09/04/2009">
		...
		<Files>
			...
			-->
			<File name="SAInspiredFencingWeaponIconPack.lua" />
		</Files>

		<OnInitialize>
			<CallFunction name="SAInspiredPaperdollFencingWeaponIconPack.Initialize" />
		</OnInitialize>
