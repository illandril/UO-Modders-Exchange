...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<UiMod name="SlayerIconPack" version="1.0" date="09/04/2009">
		...
		<Files>
			...
			<File name="SlayerIconPack.xml" />
			-->
			<File name="SlayerIconPack.lua" />
		</Files>

		<OnInitialize>
			<CallFunction name="DefaultTextSlayerIconPack.Initialize" />
		</OnInitialize>
