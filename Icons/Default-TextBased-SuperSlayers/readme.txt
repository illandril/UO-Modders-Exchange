Super Slayer Icon Pack -- Default Skin Styling using Plain Text
 Code and Packaging by Illandril (illandril@modders-exchange.net)
 Icons by Dermott of LS
...
Installation:
  ...
  The directory structure should look like the following:
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/Default-TextBased-SuperSlayers/
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/Default-TextBased-SuperSlayers/Icons/
