Fencing Weapon Pack -- Default Skin Styling using In Game Graphics
 Code and Packaging by Illandril (illandril@modders-exchange.net)
 Icons by Hawkeye Pike

Details:
  This icon pack adds Fencing Weapon icons to use when selecting an icon for Macros.
...
Installation:
  ...
  The directory structure should look like the following:
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/Default-InGameGraphics-FencingWeapons/
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/Default-InGameGraphics-FencingWeapons/Icons/
