Swords Weapon Pack -- SA Inspired Skin Styling using Paperdoll Graphics
 Code and Packaging by Illandril (illandril@modders-exchange.net)
 Icons by Zym Dragon

Details:
  This icon pack adds Swords Weapon icons to use when selecting an icon for Macros.
...
Installation:
  ...
  The directory structure should look like the following:
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/SAInspired-PaperdollGraphics-SwordsWeapons/
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/SAInspired-PaperdollGraphics-SwordsWeapons/Icons/
