Throwing Weapon Pack -- Legacy II Skin Styling using InGame Graphics
 Code and Packaging by Illandril (illandril@modders-exchange.net)
 Icons by Zym Dragon

Details:
  This icon pack adds Throwing Weapon icons to use when selecting an icon for Macros.
...
Installation:
  ...
  The directory structure should look like the following:
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/LegacyII-InGameGraphics-ThrowingWeapons/
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/LegacyII-InGameGraphics-ThrowingWeapons/Icons/
