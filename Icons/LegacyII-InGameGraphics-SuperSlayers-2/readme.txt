Super Slayer 2 Icon Pack -- Legacy II Skin Styling using In Game Graphics
 Code and Packaging by Illandril (illandril@modders-exchange.net)
 Icons by Zym Dragon

Details:
  This icon pack adds Super Slayer icons to use when selecting an icon for Macros.
...
Installation:
  ...
  The directory structure should look like the following:
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/LegacyII-InGameGraphics-SuperSlayers-2/
    {UO Directory}/UserInterface/{SKIN}/Icons/Custom/LegacyII-InGameGraphics-SuperSlayers-2/Icons/
