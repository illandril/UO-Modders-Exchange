...
ItemPropertiesEvaluator.HIGH_INTENSITY = {r=0,g=200,b=255} -- will  unravel to relic if enhanced and POFed > 50
...
ItemPropertiesEvaluator.UseItemPropertiesEvalatorColorSettingName = "UseItemPropertiesEvaluatorColor"
...
function ItemPropertiesEvaluator.Initialize()
    ...
    CustomSettingsWindow.AddBooleanSetting( "ItemPropertySettings", "UseItemPropertiesEvaluatorColor", ItemPropertiesEvaluator.UseItemPropertiesEvalatorColorSettingName, true )
...
function ItemPropertiesEvaluator.parse(labelText, labelColors)
    ...
    overrideColorOnHighIntensity = CustomSettings.LoadBooleanValue( { settingName=ItemPropertiesEvaluator.UseItemPropertiesEvalatorColorSettingName, defaultValue=true } )
	...
	for i = 1, propLen do
		...
		if intensity >= 90 then -- added by pgcd
            if overrideColorOnHighIntensity then
