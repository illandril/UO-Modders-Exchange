LoadResources( "./UserInterface/"..SystemData.Settings.Interface.customUiName.."/Mods/ObjectHandleToggleWindow", "ObjectHandleToggleWindow.xml", "ObjectHandleToggleWindow.xml" )
