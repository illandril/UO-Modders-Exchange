...
HotbarSystem.DarkItemLabel = { r=128,g=128,b=128 }
HotbarSystem.LightItemLabel = { r=0,g=0,b=0}

HotbarSystem.WARNINGLEVEL = 10

HotbarSystem.TargetTypeTintColors = {
    [SystemData.Hotbar.TargetType.TARGETTYPE_SELF] = { 75,100,255 },
    [SystemData.Hotbar.TargetType.TARGETTYPE_CURRENT] = { 200,75,100 },
    [SystemData.Hotbar.TargetType.TARGETTYPE_CURSOR] = { 75,200,100 },
    [SystemData.Hotbar.TargetType.TARGETTYPE_OBJECT_ID] = { 255,225,0 }
}
