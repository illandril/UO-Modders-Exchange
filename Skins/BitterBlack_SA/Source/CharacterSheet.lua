...
function CharacterSheet.Initialize()
	...
	for groupItr, group in pairs(CharacterSheet.Groups) do
		...
		if groupItr == 1 then -- Various layout fixes / cleanup after te first group is set
			...
			WindowAddAnchor( "CharacterSheetHealthExtra", "left", "CharacterSheetHealthAttributeValue", "right", 35, 0 )
			WindowSetDimensions( "CharacterSheetStaminaExtra" , 110, 20)
			WindowClearAnchors( "CharacterSheetStaminaExtra" )
			WindowAddAnchor( "CharacterSheetStaminaExtra", "left", "CharacterSheetStaminaAttributeValue", "right", 35, 0 )
			WindowSetDimensions( "CharacterSheetManaExtra" , 110, 20)
			WindowClearAnchors( "CharacterSheetManaExtra" )
			WindowAddAnchor( "CharacterSheetManaExtra", "left", "CharacterSheetManaAttributeValue", "right", 35, 0 )
		end
...
function CharacterSheet.SetStatLock(stat)
	...
	if val == 0 then
		...
		ButtonSetTexture(button, "Normal", "UO_Core", 186, 338)
		ButtonSetTexture(button, "NormalHighlit", "UO_Core", 167, 338)
	elseif val == 1 then
	    WindowSetDimensions(button, 22, 27)
		ButtonSetTexture(button, "Normal", "UO_Core", 236, 338)
		ButtonSetTexture(button, "NormalHighlit", "UO_Core", 212 , 338)
	elseif val == 2 then
	    WindowSetDimensions(button, 22, 27)
		ButtonSetTexture(button, "Normal", "UO_Core", 94, 338)
		ButtonSetTexture(button, "NormalHighlit", "UO_Core", 70, 338)
	end
end
