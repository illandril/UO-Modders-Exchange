...
MapCommon.ZoomLevel[MapCommon.RADAR_MODE_NAME].Step = 0.05
MapCommon.ZoomLevel[MapCommon.RADAR_MODE_NAME].Current= -0.05
MapCommon.ZoomLevel[MapCommon.RADAR_MODE_NAME].Min= -2.0
MapCommon.ZoomLevel[MapCommon.RADAR_MODE_NAME].Max= 0.5
...
function MapCommon.UpdateZoomValues(facet, area)
	if( MapCommon.ActiveView == MapCommon.MAP_MODE_NAME ) then
		...
		if( maxZoom > 0 ) then
			...
			MapCommon.ZoomLevel[MapCommon.ActiveView].Max = 1.0
			MapCommon.ZoomLevel[MapCommon.ActiveView].Step = MapCommon.ZoomLevel[MapCommon.ActiveView].Max / 10
		else
			MapCommon.ZoomLevel[MapCommon.ActiveView].Current = 0.0
			MapCommon.ZoomLevel[MapCommon.ActiveView].Min = -2.0
			MapCommon.ZoomLevel[MapCommon.ActiveView].Max = 0.0
			MapCommon.ZoomLevel[MapCommon.ActiveView].Step = 0.05
		end
	end
end
...
function MapCommon.GetWaypointScale(displayMode)
	...
	if( displayMode == MapCommon.MAP_MODE_NAME ) then
		...
		iconScale = 1.0 - (iconScale / iconSpan) * 0.75
	end
	return iconScale;
end
