...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<UiMod name="LegacyIISuperSlayerIconPack" version="1.0" date="09/04/2009">
		...
		<Files>
			...
			<File name="LegacyIISuperSlayerIconPack.xml" />
			-->
			<File name="LegacyIISuperSlayerIconPack.lua" />
		</Files>

		<OnInitialize>
			<CallFunction name="LegacyIIInGameSuperSlayerIconPack.Initialize" />
		</OnInitialize>
