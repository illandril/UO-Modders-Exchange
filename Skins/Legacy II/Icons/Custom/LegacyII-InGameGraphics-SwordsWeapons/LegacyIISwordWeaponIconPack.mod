...
<ModuleFile xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
	<UiMod name="LegacyIISwordWeaponIconPack" version="1.0" date="09/04/2009">
		...
		<Files>
			...
			<File name="LegacyIISwordWeaponIconPack.xml" />
			-->
			<File name="LegacyIISwordWeaponIconPack.lua" />
		</Files>

		<OnInitialize>
			<CallFunction name="LegacyIIInGameSwordWeaponIconPack.Initialize" />
		</OnInitialize>
